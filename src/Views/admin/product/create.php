...
<div class="products mt-20">
    ...
    <div class="form-div">
        <form action="/products/store" method="POST" onsubmit="return validateForm();">
            <div>
            ...
            <input type="number" id="price" name="price" min="0.01" step="0.01" required  placeholder="Enter price">
            </div>
            
            <div>
            <label for="available_qty">Available Quantity:</label><br/>
            <input type="number" id="available_qty" name="available_qty" min="0" required  placeholder="Enter available quantity">
            </div>
            
            <button type="submit" class="btn btn-add mt-20">Create Product</button>
        </form>
    </div>
